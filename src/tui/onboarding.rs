...
const SKILLS: &[(&str, &str)] = &[
    ...
    ("\u{1f4dd} apple-notes", "Apple Notes"),
    ("\u{2611}\u{fe0f} apple-reminders", "Apple Reminders"),
    ("\u{1f43b} bear-notes", "Note taking"),
    ("\u{1f4f0} blogwatcher", "RSS feeds"),
    ("\u{1fab0} blucli", "Bluetooth CLI"),
    ("\u{1f4ac} bluebubbles", "iMessage bridge"),
    ("\u{1f4f8} camsnap", "Camera capture"),
    ("\u{1f5bc}\u{fe0f} canvas", "HTML canvas display"),
    ("\u{1f9e9} clawhub", "Plugin registry"),
    ("\u{1f4bb} coding-agent", "Codex/Claude Code"),
    ("\u{1f4e8} discord", "Discord ops"),
    ("\u{1f6cc} eightctl", "Sleep tracking"),
    ("\u{2728} gemini", "Gemini CLI"),
    ("\u{1f41b} gh-issues", "GitHub Issues agent"),
    ("\u{1f9f2} gifgrep", "GIF search"),
    ("\u{1f4e6} github", "GitHub ops via gh"),
    ("\u{1f3ae} gog", "Google Workspace"),
    ("\u{1f4cd} goplaces", "Google Places"),
    ("\u{1f6e1}\u{fe0f} healthcheck", "Host security audit"),
    ("\u{1f4e7} himalaya", "Email CLI"),
    ("\u{1f4ac} imsg", "iMessage/SMS CLI"),
    ("\u{1f4e6} mcporter", "MCP tools"),
    ("\u{1f4ca} model-usage", "LLM usage stats"),
    ("\u{1f34c} nano-banana-pro", "Gemini image gen"),
    ("\u{1f4c4} nano-pdf", "PDF tools"),
    ("\u{1f4d3} notion", "Notion API"),
    ("\u{1f48e} obsidian", "Knowledge base"),
    ("\u{1f5bc}\u{fe0f} openai-image-gen", "OpenAI image gen"),
    ("\u{1f3a4} openai-whisper", "Speech-to-text (local)"),
    ("\u{1f399}\u{fe0f} openai-whisper-api", "Speech-to-text (API)"),
    ...
    ("\u{1f4d1} session-logs", "Session log search"),
    ("\u{1f5e3}\u{fe0f} sherpa-onnx-tts", "Local TTS (offline)"),
    ("\u{1f3ed} skill-creator", "Skill authoring"),
    ("\u{1f4e9} slack", "Slack ops"),
    ("\u{1f30a} songsee", "Music ID"),
    ("\u{1f50a} sonoscli", "Sonos control"),
    ("\u{1f3b5} spotify-player", "Spotify playback"),
    ("\u{1f9fe} summarize", "Text summary"),
    ("\u{2705} things-mac", "Task manager"),
    ("\u{1f5a5}\u{fe0f} tmux", "Tmux remote control"),
    ("\u{1f4cb} trello", "Trello boards"),
    ("\u{1f3ac} video-frames", "Video frame extract"),
    ("\u{1f4de} voice-call", "Voice calls"),
    ("\u{1f4f1} wacli", "WhatsApp CLI"),
    ("\u{26c5} weather", "Weather forecasts"),
    ("\u{1f426} xurl", "X/Twitter API"),
];
